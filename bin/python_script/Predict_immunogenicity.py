...
#python3 bin/Predict_immunogenicity.py --file data/neoepitopes_for_model.tsv --model TME_excluded  --outfile "output_prediction" 
#python3 bin/Predict_immunogenicity.py --file results/calculated_features_test.tsv --model TME_excluded  --outfile "output_prediction.tsv" 
...
if model == "TME_included": 
  add_cols = ['CelPrev','PrioScore','CYT','HLAexp','Monocytes']
  cols_to_include.extend(add_cols)
