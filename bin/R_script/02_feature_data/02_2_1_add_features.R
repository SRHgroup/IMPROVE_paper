...
# python3 bin/python_script/feature_calculations.py --file data/01_data/01_Validated_neoepitopes.txt --dataset "Validated_neoepitopes" --ProgramDir "/Users/annieborch/Documents/programs/" --outfile "data/02_feature_data/02_Validated_neoepitopes_calculated_features_test.tsv" --TmpDir "/Users/annieborch/Documents/programs/"
# -----------------------------------------------
...
all_peptides <- read.table("data/02_feature_data/02_Validated_neoepitopes_calculated_features_test.tsv", sep = "\t")
